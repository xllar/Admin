...
(()=>{
    const e = new Error("Cannot find module '@/components/content/profitlosssummary'");
...
(()=>{
    const e = new Error("Cannot find module '@/components/content/stockalerts'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
...
//# sourceMappingURL=_d68921._.js.map