...
export default function CompletedOrders() {
  const completedOrders = [
    ...
    { id: 5, customer: 'Michael Brown', total: '$150.00', date: '2025-01-10', status: 'Completed' },
    { id: 6, customer: 'Sarah Wilson', total: '$80.00', date: '2025-01-12', status: 'Completed' },
    { id: 7, customer: 'David Johnson', total: '$450.00', date: '2025-01-15', status: 'Completed' },
    { id: 8, customer: 'Emma Davis', total: '$220.00', date: '2025-01-18', status: 'Completed' },
  ];
  ...
  return (
    <section className="p-6 bg-gray-50 rounded-lg shadow-lg">
      <h2 className="text-2xl font-semibold text-gray-800 mb-6">Completed Orders</h2>
